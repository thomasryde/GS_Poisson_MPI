...
Algorithms.o: HelperFunctions.h Gauss_seidel_redblack_mp_v2.c Gauss_Seidel_Blocked.c Gauss_Seidel_nonblocked.c Gauss_seidel_redblack.c Gauss_seidel_redblack_v3.c Gauss_seidel_redblack_v2.c Gauss_seidel_redblack_mp.c Algorithms.h
	$(MPICC) -c $< $(INCLUDES) $(CFLAGS)
